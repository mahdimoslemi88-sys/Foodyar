...
// Optimization: Hoist static helper function outside component scope
...
export const POSView: React.FC = () => {
  // Optimization: Use individual selectors to prevent unnecessary re-renders when unrelated store properties change
  ...
  // Optimization: Memoize derived category list to avoid recalculation on every render
  ...
  // Optimization: Memoize aggregate cart calculations
